...
class ReadMoreText extends StatefulWidget {
  ...
  final Function onClickTrimCollapsed;
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  void _onTapLink() {
    if (widget.onClickTrimCollapsed == null) {
      setState(() => _readMore = !_readMore);
    } else {
      if (_readMore) widget.onClickTrimCollapsed();
      setState(() {});
    }
  }
